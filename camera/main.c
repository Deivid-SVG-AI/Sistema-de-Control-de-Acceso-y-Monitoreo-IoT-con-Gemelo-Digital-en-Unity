...
#define MQTT_BROKER "mqtt://192.168.3.176:1883"
#define MQTT_TOPIC_PHOTO "/clase/IoT"
...
static void camera_init(void)
{
    ...
    camera_config_t config = {
        ...
        .frame_size = (psram_size > 0) ? FRAMESIZE_SVGA : FRAMESIZE_QVGA,  // 800x600 con PSRAM, 320x240 sin PSRAM
        .jpeg_quality = 12,                  // Calidad JPEG (0-63, menor = mejor)
